Feature: disruption history
    ...
    Scenario: Test disruptions history when impact is on rail section
        Given I have the following clients in my database:
            | client_code   | created_at          | updated_at          | id                                   |
            | 5             | 2014-04-02T23:52:12 | 2014-04-02T23:55:12 | 7ffab229-3d48-4eea-aa2c-22f8680230b6 |
        Given I have the following contributors in my database:
        ...
        Given I have the following history_disruption in my database:
            | id                                    |disruption_id                         | created_at          |  data                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
            | 8ffab555-3d48-4eea-aa2c-22f8680230b6  | a750994c-01fe-11e4-b4fb-080027079ff3 | 2019-05-30T23:52:12 | {"status":"published","created_at":"2019-05-31T09:21:25Z","impacts":[{"created_at":"2019-05-31T09:21:25Z","updated_at":null,"disruption":{},"objects":[{"rail_section":{"end_point":{"type":"stop_area","id":"stop_area:DUA:SA:8768603","name":"PARIS GARE DE LYON"},"line":{"type":"line","id":"line:DUA:800804081","name":"Creil - Corbeil Essonnes"},"start_point":{"type":"stop_area","id":"stop_area:DUA:SA:8775860","name":"CHATELET LES HALLES"},"routes":[{"id":"route:DUA:10011000100010","type":"route","name":"1"},{"id":"route:DUA:10011000100011","type":"route","name":"1"}],"blocked_stop_areas":[{"id":"stop_area:DUA:SA:8775810","order":1},{"id":"stop_area:DUA:SA:8768603","order":2}]},"type":"rail_section","id":"line:DUA:800804081:76acb7f6-8385-11e9-ac12-185e0fa9992b"}],"id":"76acb7f5-8385-11e9-ac12-185e0fa9992b","severity":{"color":"#FF4455","created_at":"2016-05-31T09:13:36Z","effect":"significant_delays","updated_at":null,"priority":2,"wordings":[{"value":"ralenti","key":"short"},{"value":"20 à 30 minutes supplémentaires de trajet","key":"long"},{"value":"20 à 30 min de trajet en plus","key":"medium"}],"id":"f4b1eba4-270f-11e6-83cb-005056a47b86","wording":"20 à 30 minutes supplémentaires de trajet"},"messages":[],"send_notifications":true,"notification_date":"2019-05-31T09:21:25Z","application_period_patterns":[],"application_periods":[{"begin":"2019-05-31T09:20:00Z","end":"2019-05-31T11:20:00Z"}]}],"reference":"realtime_root-20190531112012","publication_status":"ongoing","publication_period":{"begin":"2019-05-31T09:20:00Z","end":"2019-05-31T11:20:00Z"},"localization":[],"updated_at":null,"properties":{},"note":null,"version":1,"contributor":"shortterm.tr_transilien","cause":{"category":{"updated_at":"2016-05-31T09:13:36Z","created_at":"2015-02-05T14:22:56Z","id":"7a8160fa-ad42-11e4-adc9-005056a47b86","name":"Trafic inopiné"},"updated_at":null,"id":"f4fb6568-270f-11e6-81b3-005056a44da2","wordings":[{"value":"accident de personne","key":"external_long"},{"value":"accident de personne","key":"external_short"},{"value":"accident de personne","key":"internal"},{"value":"S I accident de personne","key":"external_medium"}],"created_at":"2016-05-31T09:13:36Z"},"id":"76acb7f4-8385-11e9-ac12-185e0fa9992b","tags":[]} |
        When I get "/disruptions/a750994c-01fe-11e4-b4fb-080027079ff3/history"
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
        And the field "disruptions" should have a size of 1
        And the field "disruptions.0.impacts.impacts.0.objects" should have a size of 1
        And the field "disruptions.0.impacts.impacts.0.objects.0" should have a size of 3
        And the field "disruptions.0.impacts.impacts.0.objects.0.type" should be "rail_section"
        And the field "disruptions.0.impacts.impacts.0.objects.0.id" should be "line:DUA:800804081:76acb7f6-8385-11e9-ac12-185e0fa9992b"
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section" should have a size of 5
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.end_point" should have a size of 3
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.end_point.type" should be "stop_area"
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.end_point.id" should be "stop_area:DUA:SA:8768603"
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.end_point.name" should be "PARIS GARE DE LYON"

        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.start_point.type" should be "stop_area"
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.start_point.id" should be "stop_area:DUA:SA:8775860"
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.start_point.name" should be "CHATELET LES HALLES"

        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.line.type" should be "line"
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.line.id" should be "line:DUA:800804081"
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.line.name" should be "Creil - Corbeil Essonnes"

        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.routes" should have a size of 2
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.routes.0.type" should be "route"

        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.blocked_stop_areas" should have a size of 2

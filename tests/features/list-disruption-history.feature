...
@test
    Scenario: Test disruptions history when impact is on rail section
        ...
        And the field "disruptions.0.impacts.impacts.0.objects.0.rail_section.line.name" should be "Creil - Corbeil Essonnes / Melun / Malesherbes"

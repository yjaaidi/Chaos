Feature: disruption history
    ...
    Scenario: List of an updated disruption
        ...
        Given I have the following history_disruption in my database:
            ...
            | 8ffab555-3d48-4eea-aa2c-22f8680230b6 | a750994c-01fe-11e4-b4fb-080027079ff3 | {"status": "published", "created_at": "2014-04-02T23:52:12Z", "impacts": [{"created_at": "2019-05-27T09:44:50Z", "updated_at": null, "disruption": {}, "objects": [{"type": "network", "id": "network:JDR:1", "name": "RATP"}], "id": "121fd37d-8064-11e9-9e35-34e6d748c530", "severity": {"color": "#654321", "created_at": "2014-04-04T23:52:12Z", "effect": "unknown_effect", "updated_at": "2014-04-06T22:52:12Z", "priority": null, "wordings": [], "id": "7ffab232-3d48-4eea-aa2c-22f8680230b6", "wording": "good news"}, "messages": [], "send_notifications": false, "notification_date": null, "application_period_patterns": [], "application_periods": [{"begin": "2014-04-29T16:52:00Z", "end": "2014-06-22T02:15:00Z"}]}], "reference": "foo", "publication_status": "past", "publication_period": {"begin": "2018-09-11T13:50:00Z", "end": "2018-12-31T16:50:00Z"}, "localization": [], "updated_at": "2019-05-27T09:44:50Z", "properties": {}, "note": "hello", "version": 1, "contributor": "contrib1", "cause": {"category": null, "updated_at": "2014-04-02T23:55:12Z", "id": "7ffab230-3d48-4eea-aa2c-22f8680230b6", "wordings": [], "created_at": "2014-04-02T23:52:12Z"}, "id": "a750994c-01fe-11e4-b4fb-080027079ff3", "tags": [], "properties":[{"property_id":"e408adec-0243-11e6-954b-0050568c8382", "value":"val1"}]} | 2014-04-02T23:52:12 |
        ...
        And the field "disruptions.4.reference" should be "foo"
        And the field "disruptions.4.note" should be "hello"
        And the field "disruptions.4.cause.id" should be "7ffab230-3d48-4eea-aa2c-22f8680230b6"
        And the field "disruptions.4.publication_period.begin" should be "2018-09-11T13:50:00Z"
        And the field "disruptions.4.publication_period.end" should be "2018-12-31T16:50:00Z"
        And the field "disruptions.4.localization" should have a size of 0
        And the field "disruptions.4.properties" should have a size of 1
        And the field "disruptions.4.properties.type.0.property.id" should be "e408adec-0243-11e6-954b-0050568c8382"
        And the field "disruptions.4.properties.type.0.value" should be "val1"
        And the field "disruptions.4.tags" should have a size of 1
        And the field "disruptions.4.tags.0.name" should be "weather"
        And the field "disruptions.4.version" should be "1"
        And the field "disruptions.3.reference" should be "foo2"
        And the field "disruptions.3.note" should be null
        And the field "disruptions.3.cause.id" should be "7bfab230-3d48-4eea-aa2c-22f8680230b6"
        And the field "disruptions.3.publication_period.begin" should be "2018-09-11T13:50:00Z"
        And the field "disruptions.3.publication_period.end" should be "2018-12-31T16:50:00Z"
        And the field "disruptions.3.properties" should have a size of 0
        And the field "disruptions.3.localization" should have a size of 0
        And the field "disruptions.3.tags" should have a size of 0
        And the field "disruptions.3.version" should be "2"
        ...
        And the field "disruptions.1.reference" should be "foo3"
        And the field "disruptions.1.note" should be "note1"
        And the field "disruptions.1.cause.id" should be "7ffab230-3d48-4eea-aa2c-22f8680230b6"
        And the field "disruptions.1.publication_period.begin" should be "2018-09-15T13:50:00Z"
        And the field "disruptions.1.publication_period.end" should be "2018-12-31T16:50:00Z"
        And the field "disruptions.1.properties" should have a size of 2
        ...
        And the field "disruptions.1.properties.test.0.property.id" should be "f408adec-0243-11e6-954b-0050568c8382"
        And the field "disruptions.1.properties.test.0.value" should be "val2"
        And the field "disruptions.1.localization" should have a size of 0
        And the field "disruptions.1.tags" should have a size of 1
        And the field "disruptions.1.tags.0.name" should be "strike"
        And the field "disruptions.1.version" should be "4"
        And the field "disruptions.0.reference" should be "foo3"
        ...
        And the field "disruptions.0.publication_period.begin" should be "2018-09-15T13:50:00Z"
        And the field "disruptions.0.publication_period.end" should be "2019-01-10T16:50:00Z"
        And the field "disruptions.0.properties" should have a size of 0
        And the field "disruptions.0.localization" should have a size of 2
        And the field "disruptions.0.tags" should have a size of 2
        And the field "disruptions.0.version" should be "5"

Feature: list disruptions with ptObjects filter
    ...
    Scenario: Rail_section filter on line
        Given I have the following clients in my database:
            | client_code   | created_at          | updated_at          | id                                   |
            | 5             | 2014-04-02T23:52:12 | 2014-04-02T23:55:12 | 7ffab229-3d48-4eea-aa2c-22f8680230b6 |
        ...
        Given I have the following rail_section in my database:
            | id                                    | created_at            | updated_at          | start_object_id                      |end_object_id                       |object_id                           |blocked_stop_areas               |route_patterns                                                        |line_object_id
            | 7ffab234-3d49-4eea-aa2c-22f8680230b6  | 2014-04-04T23:52:12   | 2014-04-04T23:52:12 | 1ffab232-3d48-4eea-aa2c-22f8680230b6 |2ffab232-3d48-4eea-aa2c-22f8680230b6|3ffab232-3d48-4eea-aa2c-22f8680230b6|[{"uri":"stop_area:1","order":0}]|[[{"uri":"stop_area:0","order":0},{"uri":"stop_area:2","order":1}]]   |4ffab232-3d48-4eea-aa2c-22f8680230b6
        ...
        When I post to "/impacts/_search" with:
        """
        {"current_time": "2014-04-15T14:00:00Z", "ptObjectFilter": {"lines": ["line:JDR:M2"]}}
        """
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
        And the field "impacts" should have a size of 0

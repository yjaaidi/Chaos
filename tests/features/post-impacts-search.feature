Feature: list disruptions with ptObjects filter
    ...
    Background:
        ...
        Given I have the following causes in my database:
            ...
            | weather2  | 2014-04-02T23:52:12 | 2014-04-02T23:55:12 | True       | 7ffab230-3d48-4eea-aa2c-22f8680230b6 | 7ffab230-3d48-4eea-aa2c-22f868023042 | 7ffab229-3d48-4eea-aa2c-22f8680230b6 |
    ...
    Scenario: Filter on network and stop_area
        ...
        When I post to "/impacts/_search" with:
        """
        {"current_time": "2014-04-15T14:00:00Z", "ptObjectFilter": {"networks": ["network:JDR:1"], "stop_areas": ["stop_area:JDR:CHVIN"]}}
        """
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
    ...
    Scenario: Filter on line
        ...
        When I post to "/impacts/_search" with:
        """
        {"current_time": "2014-04-15T14:00:00Z", "ptObjectFilter": {"networks": ["network:TAD:1"], "lines": ["line:JDR:M1"]}}
        """
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
    ...
    Scenario: Filter on stop_area
        ...
        When I post to "/impacts/_search" with:
        """
        {"current_time": "2014-04-15T14:00:00Z", "ptObjectFilter": {"stop_areas": ["stop_area:JDR:CHVIN"]}}
        """
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
        And the field "impacts" should have a size of 1
    ...
    Scenario: Filter on category
        ...
        Given I have the following disruptions in my database:
            ...
            | bar       | hello | 2014-04-02T23:52:12 | 2014-04-02T23:55:12 | published | 3ffab230-3d48-4eea-aa2c-22f8680230b6 | 7ffab230-3d48-4eea-aa2c-22f8680230b6 | 7ffab229-3d48-4eea-aa2c-22f8680230b6 | 7ffab555-3d48-4eea-aa2c-22f8680230b6 | 2014-04-10T23:42:00    | 2014-04-20T23:42:00  |
    ...
    Scenario: Filter unexpected disruption
        ...
        When I post to "/impacts/_search" with:
        """
        {"current_time": "2014-04-15T14:00:00Z", "application_status":["ongoing"], "with_disruption_types": ["unexpected"]}
        """
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
        And the field "impacts" should have a size of 1
        ...
        When I post to "/impacts/_search" with:
        """
        {"current_time": "2014-04-15T14:00:00Z", "application_status":["ongoing"], "without_disruption_types": ["unexpected"]}
        """
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
        And the field "impacts" should have a size of 0

    Scenario: Filter on line for rail section
        ...
        When I post to "/impacts/_search" with:
        """
        {"current_time": "2014-04-15T14:00:00Z", "ptObjectFilter": {"lines": ["line:JDR:M2"]}, "rail_section": "true"}
        """
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
        And the field "impacts" should have a size of 0
        ...
        When I post to "/impacts/_search" with:
        """
        {"current_time": "2014-04-15T14:00:00Z", "ptObjectFilter": {"lines": ["line:JDR:M1"]}, "rail_section": "true"}
        """
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
        And the field "impacts" should have a size of 2

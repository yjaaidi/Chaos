...
#  application_period   |                                           +------------------+
#                       |
# PtObject: stop_point:JDR:BERCY4
#
#                                                                            TEST2
#
    Given I have the following clients in my database:
    ...
    Given I have the following ptobject in my database:
        | type       | uri                       | created_at          | updated_at          | id                                         |
        | stop_point | stop_point:JDR:BERCY4  | 2014-04-04T23:52:12 | 2014-04-06T22:52:12 | 1ffab232-3d48-4eea-aa2c-22f8680230b6       |
    ...
    And the field "traffic_reports.0.stop_points.0.id" should be "stop_point:JDR:BERCY4"
...
#
    ...
    Scenario: One network, one line, 2 stop_areas and 2 stop_points : http://jira.canaltp.fr/browse/TR-706
        ...
        Given I have the following ptobject in my database:
            ...
            | stop_point    | stop_point:JDR:Nantes-TGV              | 2014-04-04T23:52:12 | 2014-04-06T22:52:12 | 1ffab232-3d48-4eea-aa2c-22f8680230b5       |
            | stop_point    | stop_point:JDR:GareMontparnasse-TGV    | 2014-04-04T23:52:12 | 2014-04-06T22:52:12 | 1ffab232-3d48-4eea-aa2c-22f8680230b6       |

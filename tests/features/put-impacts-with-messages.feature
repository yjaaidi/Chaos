Feature: Manipulate messages in a impact
    ...
    Scenario: add message in a impact (2 messages)
        ...
        And the field "impact.messages.0.channel.types" should have a size of 0
        And the field "impact.messages.1.channel.id" should be "4ffab230-3d48-4eea-aa2c-22f8680230b6"
        And the field "impact.messages.1.channel.types" should have a size of 2
        And the field "impact.messages.1.channel.types.0" should be "web"
        And the field "impact.messages.1.channel.types.1" should be "mobile"

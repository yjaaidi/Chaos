Feature: Manipulate messages in a impact
    ...
    Scenario: Add an message in a impact
       ...
       Given I have the following impacts in my database:
        ...
        """
        {"severity": {"id": "7ffab232-3d48-4eea-aa2c-22f8680230b6"}, "messages": [{"text": "message 1","channel": {"id": "7ffab230-3d48-4eea-aa2c-22f8680230b6"}}]}
        """

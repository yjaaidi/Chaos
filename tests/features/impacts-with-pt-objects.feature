Feature: Manipulate impacts in a Disruption
    ...
    Scenario: Add an impact in a disruption with one object line_section with route valid
        ...
        When I post to "/disruptions/a750994c-01fe-11e4-b4fb-080027079ff3/impacts" with:
        """
        {"severity": {"id": "7ffab232-3d48-4eea-aa2c-22f8680230b6"}, "objects": [{"id":"line:JDR:M1", "type":"line_section","line_section": {"line":{"id":"line:JDR:M1","type":"line"}, "start_point":{"id":"stop_area:JDR:PTVIN", "type":"stop_area"}, "end_point":{"id":"stop_area:JDR:BERAU", "type":"stop_area"}, "routes":[{"type":"route", "id":"route:JDR:M14"}, {"type":"route", "id":"route:JDR:M1"}] }}], "application_periods": [{"begin": "2014-04-29T16:52:00Z","end": "2014-06-22T02:15:00Z"},{"begin": "2014-04-29T16:52:00Z","end": "2014-05-22T02:15:00Z"}]}
        """
        Then the status code should be "201"
        And the header "Content-Type" should be "application/json"
        And the field "impact.objects" should exist
    ...
    Scenario: Add an impact in a disruption with one object, line_section with routes
    ...
    Scenario: Add an impact in a disruption with one object line_section with one stop_area invalid
    ...
    Scenario: Add an impact in a disruption with one object rail_section with line
        Given I have the following clients in my database:
            | client_code   | created_at          | updated_at          | id                                   |
            | 5             | 2014-04-02T23:52:12 | 2014-04-02T23:55:12 | 7ffab229-3d48-4eea-aa2c-22f8680230b6 |
        ...
        And the field "impact.objects.0.rail_section.start_point.id" should be "stop_area:JDR:BASTI"
        And the field "impact.objects.0.rail_section.end_point.id" should be "stop_area:JDR:CHVIN"
        And the field "impact.objects.0.rail_section.blocked_stop_areas" should have a size of 1
        And the field "impact.objects.0.rail_section.blocked_stop_areas.0.id" should be "stop_area:1"
        And the field "impact.objects.0.rail_section.blocked_stop_areas.0.order" should be "0"
        And the field "impact.objects.0.rail_section.route_patterns" should have a size of 1
        And the field "impact.objects.0.rail_section.route_patterns.0" should have a size of 3

    Scenario: Add an impact in a disruption with one object rail_section without line
        Given I have the following clients in my database:
            | client_code   | created_at          | updated_at          | id                                   |
            | 5             | 2014-04-02T23:52:12 | 2014-04-02T23:55:12 | 7ffab229-3d48-4eea-aa2c-22f8680230b6 |
    ...
    Scenario: Add an impact in a disruption with one object rail_section with line but without route_patterns
        Given I have the following clients in my database:
            | client_code   | created_at          | updated_at          | id                                   |
            | 5             | 2014-04-02T23:52:12 | 2014-04-02T23:55:12 | 7ffab229-3d48-4eea-aa2c-22f8680230b6 |
        ...
        When I post to "/disruptions/a750994c-01fe-11e4-b4fb-080027079ff3/impacts" with:
        """
        {"severity":{"id":"7ffab232-3d48-4eea-aa2c-22f8680230b6"},"objects":[{"id":"stop_area:JDR:BASTI:stop_area:JDR:CHVIN:1","type":"rail_section","rail_section":{"line":{"id":"line:JDR:M5","type":"line"},"start_point":{"id":"stop_area:JDR:BASTI","type":"stop_area"},"end_point":{"id":"stop_area:JDR:CHVIN","type":"stop_area"},"blocked_stop_areas":[{"id":"stop_area:1","order":0}]}}],"application_periods":[{"begin":"2014-04-29T16:52:00Z","end":"2014-06-22T02:15:00Z"},{"begin":"2014-04-29T16:52:00Z","end":"2014-05-22T02:15:00Z"}]}
        """
        Then the status code should be "400"
        And the header "Content-Type" should be "application/json"
        And the field "error.message" should be "'route_patterns' is a required property"
    ...
    Scenario: Put impact with rail_section : from no line to added line
        ...
        Given I have the following rail_section in my database:
            | id                                    | created_at            | updated_at          | start_object_id                      |end_object_id                       |object_id                           |blocked_stop_areas               |route_patterns
            | 7ffab234-3d49-4eea-aa2c-22f8680230b6  | 2014-04-04T23:52:12   | 2014-04-04T23:52:12 | 1ffab232-3d48-4eea-aa2c-22f8680230b6 |2ffab232-3d48-4eea-aa2c-22f8680230b6|3ffab232-3d48-4eea-aa2c-22f8680230b6|[{"uri":"stop_area:1","order":0}]|[[{"uri":"stop_area:0","order":0},{"uri":"stop_area:2","order":1}]]
    ...
    Scenario: Put impact with line_section : delete line_section
        ...
        When I put to "/disruptions/7ffab230-3d48-4eea-aa2c-22f8680230b6/impacts/7ffab232-3d47-4eea-aa2c-22f8680230b6" with:
        """
        {"severity": {"id": "7ffab232-3d48-4eea-aa2c-22f8680230b6"}, "objects": [{"id": "network:TAD:1","type": "network"}], "application_periods": [{"begin": "2014-04-29T16:52:00Z","end": "2014-06-22T02:15:00Z"}]}
        """
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
        And the field "impact.objects" should have a size of 1
        And the field "impact.objects.0.id" should be "network:TAD:1"
        And the field "impact.objects.0.type" should be "network"
    ...
    Scenario: Put impact with line_section invalid wording in json : 2 wordings in database
        ...
        When I put to "/disruptions/7ffab230-3d48-4eea-aa2c-22f8680230b6/impacts/7ffab232-3d47-4eea-aa2c-22f8680230b6" with:
        """
        {"severity": {"id": "7ffab232-3d48-4eea-aa2c-22f8680230b6"}, "objects": [{"id":"line:JDR:M5", "type":"line_section","line_section": {"line":{"id":"line:JDR:M5","type":"line"}, "start_point":{"id":"stop_area:JDR:BASTI", "type":"stop_area"}, "end_point":{"id":"stop_area:JDR:CHVIN", "type":"stop_area"}, "routes":[{"type":"route", "id":"route:JDR:M14"}, {"type":"route", "id":"route:JDR:M1"}], "metas":[] }}], "application_periods": [{"begin": "2014-04-29T16:52:00Z","end": "2014-06-22T02:15:00Z"}]}
        """
    ...
    Scenario: Add an impact in a disruption with token invalid (no token file filter)
        ...
        Then the status code should be "201"
        And the header "Content-Type" should be "application/json"
        I fill in header "Authorization" with "chien"
        When I post to "/disruptions/a750994c-01fe-11e4-b4fb-080027079ff3/impacts" with:
        """
        {"severity": {"id": "7ffab232-3d48-4eea-aa2c-22f8680230b6"}, "objects": [{"id": "network:JDR:2","type": "network"}], "application_periods": [{"begin": "2014-04-29T16:52:00Z","end": "2014-06-22T02:15:00Z"}]}
        """

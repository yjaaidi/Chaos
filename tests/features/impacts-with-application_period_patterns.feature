...
Feature: Manipulate impacts in a Disruption
    ...
    Scenario: is-1196
        ...
        When I post to "/disruptions/a750994c-01fe-11e4-b4fb-080027079ff3/impacts" with:
        """
        {"severity": {"id": "7ffab232-3d48-4eea-aa2c-22f8680230b6"}, "application_period_patterns":[{"start_date":"2015-02-23T11:00:00Z","end_date":"2015-02-28T11:00:00Z","weekly_pattern":"1100011","time_slots":[{"begin": "11:00", "end": "19:00"}]}]}
        """
        Then the status code should be "201"
        And the header "Content-Type" should be "application/json"
        And the field "impact.application_periods" should exist

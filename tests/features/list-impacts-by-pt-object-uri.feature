Feature: list impacts by ptobject and/or uri(s)
    ...
    Scenario: Use uri for network and uri for stop_area filter to display impacts
        ...
        Given I have the following ptobject in my database:
            | type      | uri                    | created_at          | updated_at          | id                                         |
            | network   | network:1              | 2014-04-04T23:52:12 | 2014-04-06T22:52:12 | 1ffab232-3d48-4eea-aa2c-22f8680230b6       |
            | network   | network:1              | 2014-04-04T23:52:12 | 2014-04-06T22:52:12 | 2ffab232-3d48-4eea-aa2c-22f8680230b6       |
            | network   | network:1              | 2014-04-04T23:52:12 | 2014-04-06T22:52:12 | 3ffab232-3d48-4eea-aa2c-22f8680230b6       |
            | line      | line:M2                | 2014-04-04T23:52:12 | 2014-04-06T22:52:12 | 4ffab232-3d48-4eea-aa2c-22f8680230b6       |
            | line      | line:M2                | 2014-04-04T23:52:12 | 2014-04-06T22:52:12 | 5ffab232-3d48-4eea-aa2c-22f8680230b6       |
            | line      | line:M2                | 2014-04-04T23:52:12 | 2014-04-06T22:52:12 | 6ffab232-3d48-4eea-aa2c-22f8680230b6       |
            | stop_area | stop_area:CHVIN        | 2014-04-04T23:52:12 | 2014-04-06T22:52:12 | 7ffab232-3d48-4eea-aa2c-22f8680230b6       |
        ...
        I fill in header "X-Coverage" with "jdr"
        I fill in header "Authorization" with "e74598a0-239b-4d9f-92e3-18cfc120672b"
        When I get "/impacts?uri[]=network:1&uri[]=stop_area:CHVIN&start_date=2013-12-02T23:52:12Z&end_date=2014-05-21T23:52:12Z"
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
        And the field "objects" should have a size of 2
        And the field "objects.0.impacts" should have a size of 1
        And the field "objects.1.impacts" should have a size of 3
        And the field "objects.0.id" should be "stop_area:CHVIN"
        And the field "objects.0.name" should be "Château de Vincennes"
        And the field "objects.1.id" should be "network:1"
